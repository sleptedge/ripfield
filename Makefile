# Convenience targets for Ripfield.
...
PLACE_FILE ?= Ripfield.rbxlx
TEST_PLACE_FILE ?= Ripfield Tests.rbxlx
...
help:
	...
	@echo   test-verbose  Run unit tests with Ripfield logs enabled
